  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-5/6 text-white md:w-1/3 p-12 right-0 left-0  bg-black absolute mx-auto my-40 bg-opacity-80 rounded-lg"
      >
        <h1 className="text-2xl md:text-3xl my-2 font-bold ">
